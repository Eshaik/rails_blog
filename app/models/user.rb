...
# User model: Class to control all the  attributes, relations, and validation about users.
class User < ApplicationRecord
  ...
  def set_info
    self.info = "We don't know much about him/her, but we're sure that he/she is great." if info.blank?
  end
